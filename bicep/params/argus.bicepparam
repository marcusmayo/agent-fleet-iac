...
// Argus profile — multi-interface assistant (webchat + Telegram + email intake).
...
param agentName = readEnvironmentVariable('AGENT_NAME', 'heimdall')
param agentProfile = 'argus'
